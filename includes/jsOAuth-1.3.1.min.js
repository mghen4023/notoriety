...
exports.OAuth = function (a) {
    ...
    function s(a) {
        if (a !== undefined) {
            var b = a,
                c, d;
            b.constructor === String && (b = n(b)), this instanceof s ? c = this : c = new s(a), d = c.hash(b);
            return p(d)
        }
    ...
    g.prototype = {
        ...
        init: function (a) {
            ...
            this.realm = a.realm || b, this.requestTokenUrl = a.requestTokenUrl || b, this.authorizationUrl = a.authorizationUrl || b, this.accessTokenUrl = a.accessTokenUrl || b, this.getAccessToken = function () {
                ...
                function () {}, A = function () {
                    ...
                    if (q.readyState === 4) {
                        ...
                        q.status >= 200 && q.status <= 226 || q.status == 304 || q.status === 0 ? o(h) : q.status >= 400 && q.status !== 0 && p(h)
                    }
                }, s = {
        ...
        postJSON: function (a, b, c, d) {
            this.post(a, JSON.stringify(b), function (a) {
                c(JSON.parse(a.text))
            }, d)
        },
        parseTokenRequest: function (a) {
            var b = 0,
                c = a.split("&"),
                d = c.length,
                e = {};
            for (; b < d; ++b) {
                var f = c[b].split("=");
                e[g.urlDecode(f[0])] = g.urlDecode(f[1])
            }
            return e
        },
        fetchRequestToken: function (a, b) {
            ...
            this.get(this.requestTokenUrl, function (b) {
                var e = c.parseTokenRequest(b.text);
        ...
        "HMAC-SHA1": function (b, c, d) {
            ...
            b = h(b), c = h(c || ""), e = b + "&" + c, f = t(s.prototype, e, d);
            return a.btoa(f)
        }
        ...
        if (!a) return "";
        return a.replace(/%[a-fA-F0-9]{2}/ig, function (a) {
